...
const translations = {
  en: {
    ...
    home: {
      ...
      greetingMorning: "Good morning. I'm {{name}}.",
      greetingAfternoon: "Good afternoon. I'm {{name}}.",
      greetingEvening: "Good evening. I'm {{name}}.",
      greetingNight: "It's late. I'm {{name}}.",
      starting: "Starting...",
  ...
  ko: {
    ...
    home: {
      ...
      greetingMorning: "좋은 아침입니다. {{name}}입니다.",
      greetingAfternoon: "좋은 오후입니다. {{name}}입니다.",
      greetingEvening: "좋은 저녁입니다. {{name}}입니다.",
      greetingNight: "늦은 시간이네요. {{name}}입니다.",
      starting: "시작 중...",
      restarting: "재시작 중...",
      stopping: "중지 중...",
