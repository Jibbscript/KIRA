...
const translations = {
  en: {
    ...
    mcp: {
      ...
      browserVisibleLabel: "Visible browser",
      browserVisibleCopy: "Launch Playwright through a visible Chrome window managed by the desktop app.",
  ...
  ko: {
    ...
    mcp: {
      ...
      browserVisibleLabel: "Visible browser",
      browserVisibleCopy: "desktop 앱이 관리하는 실제 Chrome 창으로 Playwright를 실행합니다.",
