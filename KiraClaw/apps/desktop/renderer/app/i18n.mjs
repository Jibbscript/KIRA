...
const translations = {
  en: {
    ...
    mcp: {
      subtitle: "Only external npm MCP integrations live here.",
      ...
      failed: "Failed: {{names}}",
      settingsReadFrom: "External MCP settings are read from ~/.kira/config.env.",
      noExternalLoaded: "No external npm MCP integrations are loaded right now.",
  ...
  ko: {
    ...
    mcp: {
      subtitle: "여기에는 외부 npm MCP 연동만 표시됩니다.",
      browserTitle: "브라우저",
      ...
      failed: "실패: {{names}}",
      settingsReadFrom: "외부 MCP 설정은 ~/.kira/config.env에서 읽습니다.",
      noExternalLoaded: "현재 로드된 외부 npm MCP 연동이 없습니다.",
